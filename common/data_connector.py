...
class DataConnector:
    ...
    def uploadModelPackage(self, model_id, path, filename,status, reason, numRecords, endTime):
        ...
        query = "UPDATE datagov.ml_model_instance " \
                "SET package_file = %s, status = %s, reason = %s, num_records = %s, end_time = %s  " \
                "WHERE id  = %s"

        args = (data,status, reason, numRecords, endTime, model_id)
    ...
    def updateStatus(self, model_id, status, reason, numRecords, endTime):
        # prepare update query and data
        query = "UPDATE datagov.ml_model_instance " \
                "SET status = %s, reason = %s, num_records = %s, end_time = %s " \
                "WHERE id  = %s"

        args = (status, reason, numRecords, endTime, model_id)
    ...
    def updateValidationStatus(self, model_id, status, reason, report, numRecords, endTime):
        # prepare update query and data
        query = "UPDATE datagov.ml_model_validation_instance " \
                "SET status = %s, reason = %s, report = %s , num_records = %s, end_time = %s " \
                "WHERE id  = %s"
        print(query)
        args = (status, reason, report, numRecords, endTime, model_id)
    ...
    def updatePrediction(self, train_id, pid, status, prediction):
        # prepare update query and data
        query = "UPDATE datagov.ml_model_prediction " \
            "SET status = %s, output = %s " \
                "WHERE id  = %s"
        print(query)
        args = (status, prediction, pid)
